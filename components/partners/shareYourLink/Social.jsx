...
export default function Social() {
  return (
    <Wrapper
      styles={`flex flex-col text-start gap-7 p-8 pb-0`}
      background={`bg-neutral-900`}
      title={`Social`}
      paragraph={`Talk about us on Twitter, TikTok, Instagram or write a post on Medium and use your link to point to Framer.`}
    >
